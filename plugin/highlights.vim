...
function! s:MatchToggle()
  if exists('g:match_maps') && g:match_maps
    ...
    let g:match_maps = 1
    for i in range(1, 9)
      execute 'vnoremap <silent> m'.i.' :<C-U>call <SID>DoHighlight('.i.', 1, v:count)<CR>'
      execute 'nnoremap <silent> m'.i.' :<C-U>call <SID>DoHighlight('.i.', 2, v:count)<CR>'
    endfor
    vnoremap <silent> m0 :<C-U>call <SID>UndoHighlight(1)<CR>
    nnoremap <silent> m0 :<C-U>call <SID>UndoHighlight(2)<CR>
